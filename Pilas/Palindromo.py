...
class pilas():  # Inicializacion la clase pilas con sus metodos y atributos
    def __init__(self, size):  # Size se utiliza para ver si la lista esta llena y confirmar si se puede insertar un elemento
        self.lista = []  # La lista inicializada y vacia
...
def is_palindrome(s):  # Se crea una funcion para checar si la palabra/frase es palindromo
    list = set(
        string.ascii_lowercase)  # Se crea una variable donde se guarda la palabra en minusculas para compararla despues
...
#Programa elaborado por: Gabriela Sánchez Alcaraz
#Ultima actualizacion Tijuana, Baja California. 09/09/2021
#Iram Abbud, Gustavo Lopez